...
from rest_framework_simplejwt.views import (TokenObt ainPairView, TokenRefreshView)
from . import views
...
urlpatterns = [
    ...
    re_path(r'^admin/delete-staff/(?P<pk>.*)/$', views.delete_staff, name="delete-staff"),
