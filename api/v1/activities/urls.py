...
urlpatterns = [
    ...
    re_path(r"^remove-coupen_discount/(?P<pk>.*)/$", views.remove_coupen_discount, name="remove_coupen_discount"),
    re_path(r"^apply-wallet-amount/$", views.apply_wallet_amount, name="apply_wallet_amount"),
    re_path(r"^remove-wallet-discount/(?P<pk>.*)/$", views.remove_wallet_discount, name="remove_wallet_discount"),
    re_path(
